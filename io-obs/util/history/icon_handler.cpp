...
{
    if (m_settings->icon_cfg_path && strlen(m_settings->icon_cfg_path) > 0 && m_settings->icon_path && strlen(m_settings->icon_path) > 0)
...
icon_handler::icon_handler(sources::history_settings* settings)
    : handler(settings)
{
}
