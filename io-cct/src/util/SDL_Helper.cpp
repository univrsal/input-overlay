...
static uint32_t KEY_MAP[][2]
{
    ...
    {VC_SHIFT_L, SDLK_LSHIFT}, {VC_SHIFT_R, SDLK_RSHIFT}, {VC_META_L, SDLK_LGUI}, {VC_META_R, SDLK_RGUI},
    ...
    {VC_KP_UP, SDLK_UP}, {VC_KP_DOWN, SDLK_DOWN}, {VC_KP_LEFT, SDLK_LEFT}, {VC_KP_RIGHT, SDLK_RIGHT},
    ...
    {VC_PERIOD, SDLK_PERIOD}, {VC_SEMICOLON, SDLK_SEMICOLON}, {VC_QUOTE, SDLK_QUOTE}, {VC_BACKQUOTE, SDLK_BACKQUOTE},
