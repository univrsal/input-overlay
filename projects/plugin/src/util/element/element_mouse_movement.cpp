...
element_data_mouse_pos::element_data_mouse_pos(const int16_t x, const int16_t y) : element_data(ET_MOUSE_STATS)
{
	m_x = x;
	m_y = y;
}
...
element_mouse_movement::element_mouse_movement() : element_texture(ET_MOUSE_STATS), m_movement_type(){};
