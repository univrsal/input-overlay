...
find ./io-obs -iname *.h* -o -iname *.c* | xargs clang-format -i -verbose
find ./io-cct/src -iname *.h* -o -iname *.c* | xargs clang-format -i -verbose
find ./io-client/src -iname *.h* -o -iname *.c* | xargs clang-format -i -verbose
